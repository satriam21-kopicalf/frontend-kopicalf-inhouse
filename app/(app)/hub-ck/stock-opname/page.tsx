...
export default function HubCkStockOpnamePage() {
  ...
  const [outletName] = useState('HUB CK - Central Kitchen Jakarta');
  ...
  const handleSave = (submit: boolean) => {
    ...
    setToast({
      open: true,
      msg: submit ? 'Central Kitchen Stock Opname submitted successfully' : 'Draft saved successfully',
      sev: 'success',
    });
  };
  ...
  return (
    <Box>
      <PageHeader
        title="Central Kitchen Stock Opname"
        subtitle="HUB CK stock opname entry form — Supply Chain & Cost Control team"
        breadcrumbs={['Central Kitchen', 'Stock Opname']}
      />
